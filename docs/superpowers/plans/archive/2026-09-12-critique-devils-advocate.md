...
2. **Modo:** `skills/review/modes/critique.md` despacha o passe em paralelo (pulado com `--section`), junta sem duplicar, reavalia a recomendação e valida o relatório juntado. Versão 1.4.0, custo estimado atualizado.
