...
Sync impact report:
  ...
  Source: princípios já presentes em ARCHITECTURE.md, formalizados aqui como rule do projeto.
  ...
  Removed sections: nenhum (versão inicial)

  Templates ou docs a alinhar:
    - ARCHITECTURE.md   ✅ origem dos princípios; permanece como guia narrativo
    - ROADMAP.md        ✅ status + fases; consome a regra "YAGNI militante"
    - RELEASING.md      ✅ política de bump alinhada com Forward-only schemas
    - templates/pj_base/CLAUDE.md ⚠️ referencia 3 skills removidas no spin-off 0.3.0;
      acertar fora desta versão da constitution.
