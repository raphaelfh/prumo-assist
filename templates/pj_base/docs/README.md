...
**Schema canônico**: frontmatter de cada `type:`, convenções de link e formato de `_log.md` estão documentados nas próprias skills `/prumo-assist:wiki-*`. Não existe diretório por tipo — o tipo é campo do frontmatter, não pasta.
