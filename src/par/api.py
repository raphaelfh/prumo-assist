...
from par.domains.paper import api as paper
from par.domains.protocol import api as protocol
from par.domains.wiki import api as wiki
from par.domains.write import api as write

__all__ = ["__version__", "paper", "protocol", "skills", "wiki", "write"]
