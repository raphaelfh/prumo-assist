...
from par.core.cli_io import parse_json_list, read_stdin_text
from par.core.cli_op import cli_run
from par.domains.write import comments, compose, export, review
from par.domains.write.schemas.v1 import WriteKind, WriteMode
            ...
            for i, event in enumerate(events_file.events, start=1):
                ...
                if event.kind == review.EVENT_KIND_CITATION_DROP:
                    ...
                    action = (
                        ...
                        "no ponto certo, ou rode /par:review reconcile; "
