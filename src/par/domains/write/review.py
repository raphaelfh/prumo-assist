...
:func:`par.domains.write.export._read_docx_citations` (MÉTODO
...
class ReviewMark:
    ...
    :class:`par.core.criticmarkup.Mark` (kind ∈
    ...
    *,
    ...
    if other_pending:
        ...
        raise ValueError(
            ...
            "uma proposta do modo /par:review reconcile — e depois "
...
def _citation_atom_spans(body: str) -> Iterator[tuple[int, int]]:
    ...
    :func:`~par.core.citations.iter_citation_spans`, não aqui: é
