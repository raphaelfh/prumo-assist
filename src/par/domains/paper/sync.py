...
- Imports relativos (``from par.core.bib import ...``).
...
from par.core.bib import BibEntry, extract_field, extract_year, parse_bib
...
def sync(pj_path: Path) -> dict[str, Any]:
    ...
    from par.core.note_paths import meta_path
