...
- Fonte única de versão: `src/prumo_assist/_version.py`. NUNCA editar versão em `plugin.json`/`marketplace.json` à mão — quem escreve lá é `sync_manifest_version.py` (Princípio VII).
